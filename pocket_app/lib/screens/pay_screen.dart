          ...
          children: [
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                helperText: 'Saldo tarjeta: Bs ${cardBal.toStringAsFixed(2)}',
              ),
            ),
            const SizedBox(height: 24),
            Container(
              ...
              child: const Column(
                ...
                children: [
                  Text('Al pagar ganas:', style: TextStyle(fontWeight: FontWeight.bold)),
                  SizedBox(height: 8),
                  Text('• VIVA: 2 pts/Bs · 0.5 MB/Bs · 1% \$VIVA'),
                  Text('• Basic: 1 pt/Bs'),
